...
import TrungKienDevIcon from '../assets/nguyentrungkien-logo.png'
...
function Login() {
  ...
  return (
    <Box sx={{
      ...
      background: 'url("src/assets/nguyentrungkien-bg-img.jpg")',
          ...
          <MuiCard sx={{ minWidth: 480, maxWidth: 480, marginTop: '6em', p: '2em 1em', borderRadius: 2 }}>
            <Box sx={{ width: '70px', bgcolor: 'white', margin: '0 auto' }}>
              <a style={{ color: 'inherit', textDecoration: 'none' }} href='https://youtube.com/@nguyentrungkien' target='_blank' rel='noreferrer'>
                <img src={TrungKienDevIcon} alt='nguyentrungkien' width='100%' />
              </a>
            </Box>
            <Box sx={{ display: 'flex', justifyContent: 'center', color: theme => theme.palette.grey[500] }}>
              <Box>
                <Typography>Hint: nguyentrungkien.official@gmail.com</Typography>
                <Typography>Pass: nguyentrungkien@123</Typography>
              </Box>
            </Box>
